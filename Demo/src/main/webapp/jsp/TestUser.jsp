                    ...
                    <div class="x_panel">
                        ...
                        <div class="x_content">
                            ...
                            <div>
                                <form class="form-horizontal form-label-left">
                                    <div class="form-group">
                                        <label class="control-label col-md-1" for="userName">软件名称</label>
                                        <div class="col-md-2">
                            ...
                            <div>
                                <form class="form-horizontal form-label-left">
                                    <div class="form-group">
                                        <label class="control-label col-md-1" for="userName">一级分类</label>
                                        <div class="col-md-2">
                                            <select class="form-control">
                                                <option>Choose option</option>
                                                <option>Option one</option>
                                        ...
                                        <label class="control-label col-md-1">二级分类</label>
                                        <div class="col-md-2">
                                            <select class="form-control">
                                        ...
                                        <label class="control-label col-md-1">三级分类</label>
                                        <div class="col-md-2">
                                            <select class="form-control">
